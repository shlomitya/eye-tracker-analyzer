...
{
  // SAMPLE_PUPILXY, SAMPLE_GAZEXY, and SAMPLE_HREFXY, 
  //if out_sample_data is none of these,(tracker bug)
  // we return preferred_sample_type.	
  if(!(out_sample_data &SAMPLE_PUPILXY || out_sample_data &SAMPLE_GAZEXY || 
	  out_sample_data &SAMPLE_HREFXY ))
  {
	  return options.preferred_sample_type;
  }
