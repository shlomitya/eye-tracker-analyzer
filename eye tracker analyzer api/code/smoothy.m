function out = smoothy(signal, winlen, progress_tracking_callback_func, progress_contribution)    
    ...
    for iPoint=1:trace_length
        ...
        if ~isempty(progress_tracking_callback_func) && mod(iPoint,floor(0.1*trace_length))==0
