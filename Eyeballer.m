...
classdef Eyeballer < handle
    ...
    properties (Access= private)        
        ...
        display_range_multiplier_uicontrol;
    ...
    methods (Access= public)
        function obj= Eyeballer(save_func, raw_eye_data, timeline_left_offset, sampling_rates, manual_saccade_search_params, saccades_data, display_range_multiplier, main_fig_pos, main_gui_background_color)   
            ...
            uicontrol(interface_panel, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c1004', ...
                'String', '>', ...
                'Position', [0.72858     0.89278      0.1927      0.0523], ...
                'FontSize', 10.0, ...
                'BackgroundColor', obj.main_gui_background_color, ...
                'KeyPressFcn', @obj.keyPressCallback, ...
            ...
            uicontrol(interface_panel, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c1008', ...
                'String', '>', ...
                'Position', [0.739     0.76174      0.1927      0.0523], ...
                'FontSize', 10.0, ...
                'BackgroundColor', obj.main_gui_background_color, ...
                'KeyPressFcn', @obj.keyPressCallback, ...
            ...
            uicontrol(interface_panel, 'Style', 'text', 'tag', 'c1040', 'units', 'normalized', ...
                ...
                'Position', [0.0965     0.70412       0.809      0.0266], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
            
            uicontrol(interface_panel, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c1041', ...
                'String', '<', ...
                'Position', [0.2516     0.63145      0.1927      0.0523], ...
                'FontSize', 10.0, ...
                'BackgroundColor', obj.main_gui_background_color, ...
                'KeyPressFcn', @obj.keyPressCallback, ...
            ...
            uicontrol(interface_panel, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c1042', ...
                'String', '>', ...
                'Position', [0.5662     0.62874      0.1927      0.0523], ...
                'FontSize', 10.0, ...
                'BackgroundColor', obj.main_gui_background_color, ...
                'KeyPressFcn', @obj.keyPressCallback, ...
            ...
            uicontrol(interface_panel, 'Style', 'text', 'tag', 'c1010', 'units', 'normalized', ...
                'String', 'Tools', ...
                'Position', [0.32131     0.54147      0.3473      0.0305], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);    
            
             uicontrol(interface_panel, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c1011', ...
                'String', 'Refit Graphs', ...
                'Position', [0.23366     0.48719     0.52613      0.0407], ...
                'FontSize', 10.0, ...
                'BackgroundColor', obj.main_gui_background_color, ...
                'callback', @obj.refitGraphs, ...
                'KeyPressFcn', @obj.keyPressCallback);        
...
%                                 eyeballing_session_stats{subject_i}.(curr_subject_conds_names{cond_i}).blinked_out_saccades_nr(trial_i)= NaN;
    ...
    methods (Access= private)                        
        function plotCurrTrialSaccades(obj, do_axes_lims_reset)  
            ...
            if do_axes_lims_reset                
                set(obj.eyes_x_coords_axes, 'YLim', obj.display_range_multiplier*obj.std_range*[-1,1]);
                set(obj.eyes_y_coords_axes, 'YLim', obj.display_range_multiplier*obj.std_range*[-1,1]);        
            end
            set(obj.fig, 'name', obj.FIG_TITLE);
        ...
        function saccade_plots_hs= plotSaccade(obj, saccade_times, plot_color)                        
            ...
            function p= plotEdgeMark(time, eye_data)
                p= zeros(1,4);                
                p([1,2])= plot(obj.eyes_x_coords_axes, (time - obj.timeline_left_offset)*1000/obj.sampling_rates(obj.curr_subject), [eye_data(1), eye_data(2)], ...
                    'LineStyle', 'none', ...
                    'marker', 'o', ...
                ...
                p([3,4])= plot(obj.eyes_y_coords_axes, (time - obj.timeline_left_offset)*1000/obj.sampling_rates(obj.curr_subject), [eye_data(3), eye_data(4)], ...
                    'LineStyle', 'none', ...
                    'marker', 'o', ...
                    'markerSize', obj.SACCADE_MARKERS_SIZE, ...
                    'MarkerEdgeColor', plot_color, ...
            ...
            function p= plotEyeDataOnSaccadeSeg(saccade_seg_times, eye_data)
                p= zeros(1,4);     
                p([1,2])= plot(obj.eyes_x_coords_axes, ([saccade_seg_times; saccade_seg_times]' - obj.timeline_left_offset)*1000/obj.sampling_rates(obj.curr_subject), eye_data([1,2],:)', ...
                    'LineStyle', '-', ...
                    'LineWidth', 2, ...
                    'Color', plot_color, ...
                    'ButtonDownFcn', @obj.saccadePlotBtnDownCallback);
                
                p([3,4])= plot(obj.eyes_y_coords_axes, ([saccade_seg_times; saccade_seg_times]' - obj.timeline_left_offset)*1000/obj.sampling_rates(obj.curr_subject), eye_data([3,4],:)', ...
                    'LineStyle', '-', ...
                    'LineWidth', 2, ...
                    'Color', plot_color, ...
                    'ButtonDownFcn', @obj.saccadePlotBtnDownCallback);
        ...
        function displayedTrialAdvancePressedCallback(obj, ~, ~)
            obj.updateCurrTrial(obj.curr_trial + 1);
            obj.plotCurrTrialSaccades(true);                
        end        
        ...
        function refitGraphs(obj, ~, ~)              
            eyes_x_coords_min_val = min(min(obj.eye_data{obj.curr_subject}(obj.curr_trial).left_x), ...
                                        min(obj.eye_data{obj.curr_subject}(obj.curr_trial).right_x));
            eyes_x_coords_max_val = max(max(obj.eye_data{obj.curr_subject}(obj.curr_trial).left_x), ...
                                        max(obj.eye_data{obj.curr_subject}(obj.curr_trial).right_x));
            eyes_y_coords_min_val = min(min(obj.eye_data{obj.curr_subject}(obj.curr_trial).left_y), ...
                                        min(obj.eye_data{obj.curr_subject}(obj.curr_trial).right_y));
            eyes_y_coords_max_val = max(max(obj.eye_data{obj.curr_subject}(obj.curr_trial).left_y), ...
                                        max(obj.eye_data{obj.curr_subject}(obj.curr_trial).right_y));            
            set(obj.eyes_x_coords_axes, 'YLim', 1.1*[eyes_x_coords_min_val, eyes_x_coords_max_val]);
            set(obj.eyes_y_coords_axes, 'YLim', 1.1*[eyes_y_coords_min_val, eyes_y_coords_max_val]);
        end
...
%             save('zoom_out_icon_cdata.mat', 'zoom_out_icon_cdata');            
        ...
        function autoExtractSaccadesWithNewParamsPressedCallback(obj, ~, ~)
            ...
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2001', 'units', 'normalized', ...
                ...
                'Position', [0.066694     0.89688      0.4557     0.06562], ...
                'FontSize', 12.0, ...                
                'BackgroundColor', obj.main_gui_background_color);
            ...
            obj.auto_extraction_amp_lim_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2002', ...
                ...
                'Position', [0.7221     0.89574      0.0543     0.08106], ...
                'UserData', obj.saccades_detecetion_algorithm_params.amp_lim, ...
                'callback', {@Eyeballer.newExtractionParamEditedCallback, @Eyeballer.isStrAPositiveRealNumber});
            
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2015', 'units', 'normalized', ...
                'String', 'Eye Velocity Threshold For A Saccade (deg/ms)', ...
                'Position', [0.069144     0.69795      0.4557    0.057501], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
                        
            obj.auto_extraction_amp_low_lim_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2016', ...
                'String', obj.saccades_detecetion_algorithm_params.amp_low_lim, ...
                'Position', [0.7221      0.7971      0.0543     0.08106], ...
                'UserData', obj.saccades_detecetion_algorithm_params.amp_low_lim, ...
            ...
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2003', 'units', 'normalized', ...
                ...
                'Position', [0.0704    0.8067    0.4557    0.0575], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
            ...
            obj.auto_extraction_vel_threshold_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2004', ...
                ...
                'Position', [0.7221     0.68832      0.0543     0.08106], ...
                'UserData', obj.saccades_detecetion_algorithm_params.vel_threshold, ...
                'callback', {@Eyeballer.newExtractionParamEditedCallback, @Eyeballer.isStrAPositiveRealNumber});
                        
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2005', 'units', 'normalized', ...
                'String', 'minimum duration for a saccade (ms)', ...
                'Position', [0.070617     0.49667     0.45574    0.048762], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
            ...
            obj.min_dur_for_saccade_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2006', ...
                ...
                'Position', [0.72208     0.48165     0.0543     0.08106], ...
                'UserData', obj.saccades_detecetion_algorithm_params.saccade_dur_min, ...
            ...
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2007', 'units', 'normalized', ...
                ...
                'Position', [0.070096      0.6062     0.45574    0.039904], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
            ...
            obj.min_dur_between_saccades_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2008', ...
                ...
                'Position', [0.72208     0.58495     0.0543     0.08106], ...
                'UserData', obj.saccades_detecetion_algorithm_params.frequency_max, ...
                'callback', {@Eyeballer.newExtractionParamEditedCallback, @Eyeballer.isStrAValidPositiveInteger});                                           
            
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2009', 'units', 'normalized', ...
                'String', 'lowpass filter (hz)', ...
                'Position', [0.0552    0.4056    0.4557    0.0399], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
            ...
            obj.lowpass_filter_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2010', ...
                ...
                'Position', [0.72208      0.3822     0.0543     0.08106], ...
                'UserData', obj.saccades_detecetion_algorithm_params.low_pass_filter, ...
                'callback', {@Eyeballer.newExtractionParamEditedCallback, @Eyeballer.isStrAPositiveRealNumber});
                                    
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'text', 'tag', 'c2011', 'units', 'normalized', ...
                'String', 'display range multiplier (hz)', ...
                'Position', [0.068089     0.30602     0.45574    0.043831], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color);
            
            obj.display_range_multiplier_uicontrol= uicontrol(obj.auto_extraction_params_fig, 'Style', 'edit', 'units', 'normalized', 'tag', 'c2012', ...
                'String', obj.display_range_multiplier, ...
                'Position', [0.72208     0.28139     0.0543     0.08106], ...
                'UserData', obj.display_range_multiplier, ...
                'callback', {@Eyeballer.newExtractionParamEditedCallback, @Eyeballer.isStrAPositiveRealNumber});                        
            
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c2013', ...
                'String', 'Go', ...
                'Position', [0.1305    0.061839      0.3176      0.1734], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color, ....
                'callback', @obj.startNewExtractionPressedCallback);
            
            uicontrol(obj.auto_extraction_params_fig, 'Style', 'pushbutton', 'units', 'normalized', 'tag', 'c2014', ...
                'String', 'Cancel', ...
                'Position', [0.59038     0.05721      0.3176      0.1734], ...
                'FontSize', 12.0, ...
                'BackgroundColor', obj.main_gui_background_color, ....
        ...
        function startNewExtractionPressedCallback(obj, ~, ~)
            ...
            new_display_range_multiplier = str2double(get(obj.display_range_multiplier_uicontrol, 'string'));
            if isempty(new_display_range_multiplier)
                errordlg('missing display range multiplier');
                return;                
            end  
            ...
            obj.new_extraction_params.eyeballer_display_range_multiplier = new_display_range_multiplier;
            close(obj.fig);
