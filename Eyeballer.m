...
classdef Eyeballer < handle
    ...
    methods (Access= public)
        function obj= Eyeballer(save_func, raw_eye_data, detection, timeline_left_offset, sampling_rates, manual_saccade_search_params, saccades_data, display_range_multiplier, main_fig_pos, main_gui_background_color)   
...
%             save('zoom_out_icon_cdata.mat', 'zoom_out_icon_cdata');            
    ...
    methods (Access= private, Static)
        ...
        function res = boolToVisibility(bool)
            if (bool)
                res = 'on';
            else
                res = 'off';
